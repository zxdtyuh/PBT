...
package GK_X_Squared_Table is
    ...
    ---------------------------------------------------------------------
    -- 7-point Gauss nodes (magnitudes) and weights
    ---------------------------------------------------------------------
    constant GAUSS_NODES : gk_array_t(0 to 3) := (
        0 => x"F2F8BC73E",  -- 0.94910791234275926264
        1 => x"BDD4FCDF2",  -- 0.74153118559939443986
        2 => x"67E577C46",  -- 0.40584515137739716907
        3 => x"000000000"   -- 0.00000000000000000000
    );
    ...
    constant KRONROD_NODES : gk_array_t(0 to 7) := (
        ...
        1 => x"F2F8BC73E",  -- 0.94910791234275926264
        2 => x"DD67C13DD",  -- 0.86486442335976907279
        3 => x"BDD4FCDF2",  -- 0.74153118559939443986
        4 => x"9609D024F",  -- 0.58608723546769113029
        5 => x"67E577C46",  -- 0.40584515137739716907
        6 => x"353165126",  -- 0.20778495500789846760
        7 => x"000000000"   -- 0.00000000000000000000
    );
